        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-card-foreground">Total Score</p>
                    ...
                    <div className="flex-1">
                      ...
                      {post.url && (
                        <a
                          ...
                          className="text-primary hover:text-primary/80 hover:underline flex items-center gap-1 mb-3"
                        >
            ...
            <div className="p-6 space-y-6">
                ...
                {selectedPost.url && (
                  <div className="mb-4">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-primary hover:text-primary/80 hover:underline flex items-center gap-2 text-lg"
                    >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-purple-50 bg-purple-900/20 p-4 rounded-lg text-center">
                  ...
                  <div className="text-sm text-card-foreground">Author</div>
                </div>
                <div className="bg-blue-50 bg-blue-900/20 p-4 rounded-lg text-center">
                  ...
                  <div className="text-sm text-card-foreground">Posted</div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-50 bg-gray-700 p-4 rounded-lg">
                    <h5 className="font-medium text-card-foreground mb-2">Score-to-Comment Ratio</h5>
                  ...
                  <div className="bg-gray-50 bg-gray-700 p-4 rounded-lg">
                    <h5 className="font-medium text-card-foreground mb-2">Post Type</h5>
              ...
              {/* Timing Information */}
              <div>
                <h4 className="text-lg font-semibold text-card-foreground mb-3">Timing Information</h4>
                <div className="bg-gray-50 bg-gray-700 p-4 rounded-lg">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <div className="text-sm text-card-foreground">Posted Date</div>
                    ...
                    <div>
                      <div className="text-sm text-card-foreground">Posted Time</div>
                      <div className="font-medium text-card-foreground">
                    ...
                    <div>
                      <div className="text-sm text-card-foreground">Hours Since Posted</div>
                      <div className="font-medium text-card-foreground">
                        {Math.floor((Date.now() - selectedPost.time * 1000) / (1000 * 60 * 60))} hours
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-card-foreground">Unix Timestamp</div>
